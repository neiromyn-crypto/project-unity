    ...
    public sealed class GameRoot : MonoBehaviour
    {
        ...
        private void Start()
        {
            try
            {
                ...
                save=new SaveService(Path.Combine(Application.persistentDataPath,"dawnguard-v1.json"));
                ...
                World=gameObject.AddComponent<WorldView>(); World.Initialize(this,catalog);
                Hud=gameObject.AddComponent<HudView>(); Hud.Initialize(this);
        ...
        private void OnPhase()
        {
            ...
            else if(Completed) Message="Пять ночей пройдены!";
        ...
        public void SelectBuild(string id)
        {
            ...
            Message="Выбрано: "+Game.Rules.Building(id).title+". Нажмите свободную клетку.";
        }
        ...
        public void StartNight() { if(!Paused && !Completed) Game.StartNight(); }
        ...
        private void SaveNow() { if(save!=null && Game!=null && !save.Save(Game,Completed)) Message=save.Warning; }
